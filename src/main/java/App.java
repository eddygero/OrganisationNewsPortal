...
//        String connectionString = "jdbc:postgresql://localhost:5432/organisational_news_portal"; //connect to postgres, not postgres_test!
//        Sql2o sql2o = new Sql2o(connectionString, "kingdice", "8203");  //Ubuntu Sql2o sql2o = new Sql2o(connectionString, "user", "1234");
        ...
        Sql2o sql2o = new Sql2o(connectionString,"postgres","edwardgero33"); //!
